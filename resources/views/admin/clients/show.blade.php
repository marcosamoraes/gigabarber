        ...
        <div class="main-container container-fluid">
            <div class="inner-body">
                ...
                <div class="page-header">
                    <div>
                        <h2 class="main-content-title tx-24 mg-b-5">Visualizar Cliente</h2>
                        <ol class="breadcrumb">
                        ...
                        <div class="card custom-card">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Título" name="attributes[title]"
                                        value="{{ old('attributes.title', $client->attributes->title) }}" required>
                                </div>
                                <div class="form-group">
                                    <label class="tx-medium">Descrição</label>
                                    <textarea name="description" id="attributes[description]" placeholder="Descrição" class="form-control" rows="3">{{ old('attributes.description', $client->attributes->description) }}</textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" name="attributes[image]" id="image">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="cep" class="form-control" placeholder="CEP"
                                        name="address[cep]" value="{{ old('address.cep', $client->address[0]->cep) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="address" class="form-control" placeholder="Endereço"
                                        ...
                                        value="{{ old('address.address', $client->address[0]->address) }}" maxlength="50"
                                        required>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" id="number" class="form-control" placeholder="Número"
                                        name="address[number]"
                                        value="{{ old('address.number', $client->address[0]->number) }}" maxlength="4"
                                        required>
                                </div>
                                <div class="form-group">
                                    <label class="tx-medium">Bairro</label>
                                    <input type="text" id="area" class="form-control" placeholder="Bairro"
                                        name="address[area]" value="{{ old('address.area', $client->address[0]->area) }}"
